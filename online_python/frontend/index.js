...
// let root2 = new Vue({
//     el: '#app2',
//     template: '<div><h1>{{message}}</h1><code-input></code-input><hr><code-list></code-list><hr><code-options></code-options><hr><code-output></code-output></div>',
//     data: {
//         message: 'This is Root test'
//     },
//     components: {
//         'code-input': input,
//         'code-list': list,
